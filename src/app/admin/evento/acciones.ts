...
export async function guardarEvento(
  ...
  const analisis = esquemaEvento.safeParse({
    ...
    cuentaNombre: formulario.get('cuentaNombre'),
    cuentaRut: formulario.get('cuentaRut'),
    cuentaCorreo: formulario.get('cuentaCorreo'),
    cuentaBanco: formulario.get('cuentaBanco'),
    cuentaTipo: formulario.get('cuentaTipo'),
    cuentaNumero: formulario.get('cuentaNumero'),
    cuentaQrUrl: formulario.get('cuentaQrUrl'),
  });
  ...
  try {
    await prisma.evento.update({
      ...
      data: {
        ...
        eventoCuentaNombre: d.cuentaNombre || null,
        eventoCuentaRut: d.cuentaRut || null,
        eventoCuentaCorreo: d.cuentaCorreo || null,
        eventoCuentaBanco: d.cuentaBanco || null,
        eventoCuentaTipo: d.cuentaTipo || null,
        eventoCuentaNumero: d.cuentaNumero || null,
        eventoCuentaQrUrl: d.cuentaQrUrl || null,
